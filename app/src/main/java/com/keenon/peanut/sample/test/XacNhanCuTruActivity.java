...
public class XacNhanCuTruActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Xin Giấy Xác Nhận Cư Trú");
        setButtonBack();
        ...
        // Set title
        tvTitle.setText("Xin Giấy Xác Nhận Cư Trú");
        ...
        // Tạo mã QR
        String qrData = "XAC_NHAN_CU_TRU_" + String.format("%03d", queueNumber) + "_" + System.currentTimeMillis();
