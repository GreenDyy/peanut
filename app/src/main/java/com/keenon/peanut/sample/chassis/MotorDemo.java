...
//    PrintLnLog.d(MotorDemo.this, tvApiLog, svApiLog, sb, "Registered runtime listener for motor events");
//
...
//
//      @Override
//      public void onFail(com.keenon.sdk.hedera.model.ApiError error) {
...
//          PrintLnLog.d(MotorDemo.this, tvApiLog, svApiLog, sb, "Motor events will be received via onEvent() callback");
//        } else {
...
//          @Override
//          public void onSuccess(String requestId, String result) {
//            PrintLnLog.d(MotorDemo.this, tvApiLog, svApiLog, sb, "manual run success (overload), requestId: " + requestId + ", result: " + result);
//          }
//
//          @Override
//          public void onFail(com.keenon.sdk.hedera.model.ApiError error) {
//            PrintLnLog.d(MotorDemo.this, tvApiLog, svApiLog, sb, "manual run error = " + error.toString());
//          }
