...
public class TamTruActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set title
        tvTitle.setText("Khai Báo Tạm Trú");
        ...
        // Tạo mã QR
        String qrData = "TAM_TRU_" + String.format("%03d", queueNumber) + "_" + System.currentTimeMillis();
